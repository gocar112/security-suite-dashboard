# Security Studio Operator Guide

<p align="center">
  <img src="../assets/security-studio-icon.png" alt="Security Studio shield and radar icon" width="180">
</p>

<p align="center"><strong>Detection, investigation, containment, and recovery for local operators</strong></p>

Version: 2026-09-12

This book explains how to run Security Studio, read the dashboard, triage
...
Security Studio is built for local defensive testing and small SOC-style
...
5. Monitoring: Security Studio watches suspicious downloads and shows logs.
...
- Confirm the browser is connected to `127.0.0.1:8900`.
